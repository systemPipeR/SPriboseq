...
Rscript -e "rmarkdown::render('SPriboseq.Rmd', c('BiocStyle::html_document'), clean=F); knitr::knit('SPriboseq.Rmd', tangle=TRUE)"; Rscript -e "rmarkdown::render('SPriboseq.Rmd', c('BiocStyle::pdf_document'))"
-->
...
`results/` directory, while the `SPriboseq.Rmd` script and the `targets` file are expected to be located in the parent directory. The R session is expected to run from this parent
...
Now open the R markdown script `SPriboseq.Rmd`in your R IDE (_e.g._ vim-r or RStudio) and 
...
rmarkdown::render("SPriboseq.Rmd", "html_document")
rmarkdown::render("SPriboseq.Rmd", "pdf_document")
```
